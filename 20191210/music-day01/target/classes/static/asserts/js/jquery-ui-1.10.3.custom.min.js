...
(function (t, e) {
    ...
    t.cleanData = function (e) {
        ...
        }), a.prototype = t.widget.extend(h, {widgetEventPrefix: r ? h.widgetEventPrefix : i}, l, {
            constructor: a,
            namespace: c,
            widgetName: i,
            widgetFullName: o
...
(function (t) {
    t.widget("ui.draggable", t.ui.mouse, {
        ...
        start: function () {
            ...
            }).left - d.margins.left)), !d.snapElements[p].snapping && (i || o || n || r || f) && d.options.snap.snap && d.options.snap.snap.call(d.element, e, t.extend(d._uiHash(), {snapItem: d.snapElements[p].item})), d.snapElements[p].snapping = i || o || n || r || f)
        }
    ...
    t.widget("ui.resizable", t.ui.mouse, {
        ...
        _create: function () {
            ...
            if (this.element.addClass("ui-resizable"), t.extend(this, {
                ...
                ne: ".ui-resizable-ne",
                nw: ".ui-resizable-nw"
            } : "e,s,se"), this.handles.constructor === String) for ("all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"), e = this.handles.split(","), this.handles = {}, i = 0; e.length > i; i++) s = t.trim(e[i]), n = "ui-resizable-" + s, o = t("<div class='ui-resizable-handle " + n + "'></div>"), o.css({zIndex: a.zIndex}), "se" === s && o.addClass("ui-icon ui-icon-gripsmall-diagonal-se"), this.handles[s] = ".ui-resizable-" + s, this.element.append(o);
        ...
        _mouseStart: function (i) {
            ...
            return this.resizing = !0, /absolute/.test(h.css("position")) ? h.css({
                ...
                width: h.width(),
                height: h.height()
            }, this.originalPosition = {left: s, top: o}, this.sizeDiff = {
        ...
        _mouseDrag: function (e) {
            var i, s = this.helper, o = {}, n = this.originalMousePosition, r = this.axis, a = this.position.top,
                h = this.position.left, l = this.size.width, p = this.size.height, c = e.pageX - n.left || 0,
                d = e.pageY - n.top || 0, f = this._change[r];
        ...
        _respectSize: function (t) {
            var e = this._vBoundaries, s = this.axis, o = i(t.width) && e.maxWidth && e.maxWidth < t.width,
                ...
                p = /sw|nw|w/.test(s), c = /nw|ne|n/.test(s);
        ...
        stop: function (e) {
            var i = t(this).data("ui-resizable"), s = i.options, o = i._proportionallyResizeElements,
                n = o.length && /textarea/i.test(o[0].nodeName),
                r = n && t.ui.hasScroll(o[0], "left") ? 0 : i.sizeDiff.height, a = n ? 0 : i.sizeDiff.width,
        ...
        start: function () {
            var i, s, o, n, r, a, h, l = t(this).data("ui-resizable"), p = l.options, c = l.element, d = p.containment,
            ...
            var i, s, o, n, r = t(this).data("ui-resizable"), a = r.options, h = r.containerOffset, l = r.position,
                p = r._aspectRatio || e.shiftKey, c = {top: 0, left: 0}, d = r.containerElement;
            ...
            var e = t(this).data("ui-resizable"), i = e.options, s = e.containerOffset, o = e.containerPosition,
                n = e.containerElement, r = t(e.helper), a = r.offset(), h = r.outerWidth() - e.sizeDiff.width,
        ...
        start: function () {
            ...
            var s = t(this).data("ui-resizable"), o = s.options, n = s.originalSize, r = s.originalPosition, a = {
                ...
                t(e).each(function () {
                    var e = t(this), o = t(this).data("ui-resizable-alsoresize"), n = {},
        ...
        resize: function () {
            var e = t(this).data("ui-resizable"), i = e.options, s = e.size, o = e.originalSize, n = e.originalPosition,
                r = e.axis, a = "number" == typeof i.grid ? [i.grid, i.grid] : i.grid, h = a[0] || 1, l = a[1] || 1,
                p = Math.round((s.width - o.width) / h) * h, c = Math.round((s.height - o.height) / l) * l,
                d = o.width + p, f = o.height + c, u = i.maxWidth && d > i.maxWidth, g = i.maxHeight && f > i.maxHeight,
                m = i.minWidth && i.minWidth > d, v = i.minHeight && i.minHeight > f;
    ...
    t.widget("ui.sortable", t.ui.mouse, {
        ...
        _intersectsWith: function (t) {
            var e = this.positionAbs.left, i = e + this.helperProportions.width, s = this.positionAbs.top,
                n = s + this.helperProportions.height, o = t.left, r = o + t.width, a = t.top, h = a + t.height,
                l = this.offset.click.top, c = this.offset.click.left,
                p = "x" === this.options.axis || s + l > a && h > s + l,
                u = "y" === this.options.axis || e + c > o && r > e + c, f = p && u;
        ...
        _intersectsWithPointer: function (t) {
            var i = "x" === this.options.axis || e(this.positionAbs.top + this.offset.click.top, t.top, t.height),
                ...
                n = i && s, o = this._getDragVerticalDirection(), r = this._getDragHorizontalDirection();
